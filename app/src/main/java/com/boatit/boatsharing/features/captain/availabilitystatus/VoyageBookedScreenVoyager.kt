...
fun VoyageBookedScreenVoyager(
    ...
    createVoyageDraftStore: CreateVoyageDraftStore = get(CreateVoyageDraftStore::class.java),
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = { navController.navigateToVoyagerDashboard() },
                    ...
                    onClick = {
                        if (activeVoyageId.isNotBlank()) {
                            viewModelStripe.loadPaymentSheetConfig(
                                SponsorVoyagePaymentRequest(activeVoyageId, "", userSessionStore.currentUserId()),
                            )
                        } else {
                            Toast.makeText(context, "Missing voyage id", Toast.LENGTH_SHORT).show()
                        }
                    },
