...
@Composable
fun FindDestinationLocationScreen(
                    ...
                    Column(
                        ...
                        Box(
                            ...
                            OutlinedTextField(
                                ...
                                enabled = false,
                                label =
                                    if (!isPickUpLocationFocused && pickUpLocation.isEmpty()) {
                                        {
                                            Text(
                        ...
                        Box(
                            ...
                            OutlinedTextField(
                                ...
                                onValueChange = {},
                                label =
                                    if (!isDestinationLocationFocused && destinationLocation.isEmpty()) {
                                        {
                                            Text(
