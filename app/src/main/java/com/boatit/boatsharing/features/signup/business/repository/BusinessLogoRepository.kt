...
class BusinessLogoRepository(private val httpClient: HttpClient) {
    suspend fun saveBusinessLogo(
        ...
        return try {
            val response: HttpResponse =
                httpClient.post("${ApiConstants.BASE_URL}${ApiConstants.Endpoints.SAVE_BUSINESS_LOGO}") {
                            ...
                            formData {
                                ...
                                logoFiles.forEach { file ->
                                    appendInput(
                                        ...
                                        file?.inputStream()?.asInput() ?: error("Image file is required")
                                    }
                                }
                            },
                        ),
    ...
    suspend fun saveBusinessGallery(
        userId: String,
        logoFiles: List<File?>,
    ): Result<SaveBusinessLogoResponse> {
        return try {
