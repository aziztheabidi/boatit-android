package com.boatit.boatsharing.features.signup.business.view
        ...
        content = { innerPadding ->
            if (isLoading || getingData) {
                ...
                Column(
                    ...
                    if (showDialog.value) {
                        com.boatit.boatsharing.features.signup.captain.view.MyDatePickerDialog(
                            onDateSelected = {
                                bookingDate = it
                                dob = bookingDate
                            },
                    ...
                    CustomTextField(
                        ...
                        maxChars = 100,
                        errorMessage =
                            if (!isEmailValid && paypalEmail.isNotEmpty()) {
                                stringResource(
