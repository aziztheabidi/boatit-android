...
class SponcerVoyagesViewModel(private val repository: SponcerVoyagesRepo) : ViewModel() {

    private val _loginState = MutableStateFlow<NetworkResponse<SponsorPayments>>(NetworkResponse.Loading())
    val loginState: StateFlow<NetworkResponse<SponsorPayments>> = _loginState
