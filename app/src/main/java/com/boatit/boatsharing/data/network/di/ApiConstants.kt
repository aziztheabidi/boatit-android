...
object ApiConstants {
    val BASE_URL = MainApplication.appContext.getString(R.string.baseUrl)
    ...
    object Endpoints {
        ...
        const val CATEGORY = "/Lookup/VoyageCategory"
        const val Zones = "/Lookup/Dock"
        const val FIND_BOAT = "/Voyage/FindBoat"
        const val FETCH_BUSINESS = "/Voyager/GetBusinessRelationship"
